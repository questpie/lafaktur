...
import { ComponentTypeEditor } from "~/app/[locale]/(main)/[organization]/templates/[id]/_components/template-editor/editors/component-type-editor";
import { FontEditor } from "~/app/[locale]/(main)/[organization]/templates/[id]/_components/template-editor/editors/font-editor";
import { GeneralEditor } from "~/app/[locale]/(main)/[organization]/templates/[id]/_components/template-editor/editors/general-editor";
import { LayoutEditor } from "~/app/[locale]/(main)/[organization]/templates/[id]/_components/template-editor/editors/layout-editor";
import { ListMapByEditor } from "~/app/[locale]/(main)/[organization]/templates/[id]/_components/template-editor/editors/list-map-by-editor.tsx";
import { SizeEditor } from "~/app/[locale]/(main)/[organization]/templates/[id]/_components/template-editor/editors/size-editor";
import { SpacingEditor } from "~/app/[locale]/(main)/[organization]/templates/[id]/_components/template-editor/editors/spacing-editor";
import { TextContentEditor } from "~/app/[locale]/(main)/[organization]/templates/[id]/_components/template-editor/editors/text-content-editor";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
