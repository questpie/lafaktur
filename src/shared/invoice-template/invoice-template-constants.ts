...
export const INVOICE_VARIABLE_LABELS: Record<InvoiceVariable, string> = {
  ...
  item_quantity: "Invoice item quantity",
  item_unit: "Invoice item unit",
  item_unit_price: "Invoice item unit price",
  item_unit_price_without_vat: "Invoice item unit price without VAT",
  item_total: "Invoice item total",
  item_total_without_vat: "Invoice item total without VAT",
  total: "Invoice total",
